        ...
        <div class="row s_product_inner">
                    ...
                    <ol class="carousel-indicators">
                      @foreach($product->images as $key=>$image)
                        <li data-target="#carouselExampleIndicators" data-slide-to="{{$key}}" @if($key +1 == 1) class="active" @endif >
                            <img width="55" src="{{asset('storage/products/'.$image->image)}}" alt="" />
                        </li>
                      @endforeach
                    </ol>
          ...
          <div class="col-lg-5 offset-lg-1">
            <div class="s_product_text">
              <form action="{{url('addtocart/'.$product->slug)}}" method="post" id="addCart" data-type="JSON">
                @csrf
                <h3>{{ $product->name }}</h3>
                ...
                <ul class="list">
                  <li>
                    <a class="active" href="#">
                      <span>Category</span> : {{ $product->subcategories()->with('category')->get()->pluck('category')->unique('id')->first()->name }} </a
                    >
                  </li>
                  <li>
                    @if($product->stock > 1)
                    ...
                    @else
                    <a href="#" class="text-danger"> <span>Availibility</span> : Stock Out</a>
                    @endif
                  </li>
                </ul>
                <p>
                ...
                <div class="form-check form-check-inline">
                    <input class="form-check-input" type="radio" name="color" value="{{ $color->name }}" {{ $key == 0 ? 'checked':'' }} >
               ...
               @endforeach
                ...
                <div class="card_area">
                <button class="main_btn" {{$product->stock == 0 ? 'disabled':'' }} id="cartItems" >Add to Cart</button>
          ...
          <div class="col-lg-6">
            <div class="comment_list">
                <div class="review_item">
                    <div class="media">
                        <div class="d-flex">
                            <img src="{{asset('contents/website')}}/img/product/single-product/review-1.png" alt="" />
                        </div>
          ...
          >
            <div class="row">
                ...
                <div class="review_list">
                  ...
                  <div class="review_item">
                    <div class="media">
                      <div class="d-flex">
                        <img
                          src="{{asset('contents/website')}}/img/product/single-product/review-2.png"
                          alt=""
                        />
                      </div>
                      <div class="media-body">
                  ...
                  <div class="review_item">
                    <div class="media">
                      <div class="d-flex">
                        <img
                          src="{{asset('contents/website')}}/img/product/single-product/review-3.png"
                          alt=""
                        />
                      </div>
                      <div class="media-body">
              ...
              <div class="col-lg-6">
                <div class="review_box">
                  @guest()
                  <h5 class="text-center"><a class="text-danger" href="{{ url('login') }}">Please login first for review</a></h5>
                  @else
                  <h4>Add a Review</h4>
                     <form action="{{url('product/review/'.$product->slug)}}" method="post" id="better-rating-form">
                      @csrf
                        ...
                        <div class="rating">
                         ...
                         <textarea name="review" class="form-control" id="" cols="30" rows="7" required></textarea>
