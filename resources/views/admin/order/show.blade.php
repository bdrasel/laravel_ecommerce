                ...
                <div class="card-body">                                
                    <div class="row mb-5">
                        <div class="col-md-6 col-lg-6 col-xl-3">
                            ...
                            <h6>Order Placed</h6>
                            <p class="mb-0">{{ date_format($order->created_at, 'd M, Y h:ia' ) }}</p> 
                            </div>
                        </div>
                        <div class="col-md-6 col-lg-6 col-xl-3">
                            <div class="order-primary-detail mb-4">
                    ...
                    <div class="row">
                        <div class="col-md-6 col-lg-6 col-xl-6 ">
                            ...
                            <p>{{ $order->shipping->address }},<br/> {{ $order->shipping->city }}.<br/>{{ $order->shipping->country }}</p>
                        ...
                        <table class="table table-borderless">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><img src="{{asset('contents/admin')}}/images/ecommerce/product_01.svg" class="img-fluid" width="35" alt="product"></td>
                                    <td>{{ Str::limit($product->product_name,10) }}</td>
                                    <td>{{ $product->discount }}</td>
                                    <td>{{ $product->qty }}</td>
                                    <td>TK{{ $product->price }}</td>
                                    <td class="text-right">TK {{ ($product->price * $product->qty) -( $product->discount *  $product->qty) }}</td>
                                </tr>
                               @endforeach
                            </tbody>
                        </table>
                                ...
                                <table class="table table-borderless text-right">
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-black f-w-7 font-18">TK{{ $order->order_total + $order->shipping_charge }}</td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
