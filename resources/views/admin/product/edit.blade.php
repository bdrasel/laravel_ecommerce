            ...
            <div class="card m-b-30">
                ...
                <div class="card-body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-12">
                                <input type="text" class="form-control font-20" name="name" value="{{$product->name}}">
                               @error('name') 
                            ...
                            <div class="tab-content" id="v-pills-product-tabContent">
                                <div class="tab-pane fade show active" id="v-pills-general" role="tabpanel" aria-labelledby="v-pills-general-tab">
                                        ...
                                        <div class="form-group row mb-0">
                                            ...
                                            <div class="col-sm-8">
                                                <input type="text" value="{{$product->discount}}"  name="discount" class="form-control" placeholder="50">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row mb-0">
                                            ...
                                            <div class="col-sm-8">
                                                <input type="text" value="{{$product->stock}}"  name="stock" class="form-control" placeholder="100">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label for="weight" class="col-sm-12 col-form-label">Product Description</label>
                                            <div class="col-sm-12">
                                              <textarea class="form-control" name="description" cols="76" rows="6">{{$product->description}}</textarea>
                                            </div>
                                       </div> 
            ...
            <div class="card m-b-30">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="default-date" value="{{$product->new_from}}" name="new_from" class="datepicker-here form-control" />      
                    </div>

                     <div class="form-group">
                        <label>New To</label>  <br>                                
                        <input type="text" id="default-date-to"  value="{{$product->new_to}}" name="new_to" class="datepicker-here form-control" />    
                     </div>
                </div>
            </div>
         </div>
